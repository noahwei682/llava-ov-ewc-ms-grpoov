...
ACCELERATE_CPU_AFFINITY=1 torchrun --nproc_per_node $NPROC_PER_NODE --nnodes $NODES --node_rank $NODE_RANK --master_addr $MASTER_ADDR --master_port $MASTER_PORT \
    ...
    --data_path "/home/aiscuser/lmms-eval/LLaVA-NeXT/mydatasets/llava_onevision/{llava_onevision_chrome_writting,llava_onevision_ai2d_internvl}.json" \
    --image_folder /home/aiscuser/lmms-eval/LLaVA-NeXT/mydatasets/llava_onevision/merged_images \
